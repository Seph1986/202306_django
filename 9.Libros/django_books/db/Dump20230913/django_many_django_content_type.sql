...
INSERT INTO `django_content_type` VALUES (3,'admin','logentry'),(5,'auth','group'),(4,'auth','permission'),(6,'auth','user'),(7,'contenttypes','contenttype'),(2,'many_to_many','author'),(1,'many_to_many','book'),(8,'sessions','session');
